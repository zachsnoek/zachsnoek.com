export const title = 'Using local NPM packages as dependencies with yalc';
export const date = '2021-08-14';
export const description = 'How to link local NPM packages with yalc.';
export const categories = ['software engineering'];
export const tags = ['npm', 'javascript', 'web development'];
