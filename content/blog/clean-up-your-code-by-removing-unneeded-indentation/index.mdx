export const title = 'Clean up your code by removing unneeded indentation 🧹';
export const date = '2021-01-08';
export const description = 'Use this technique to clean up your code.';
export const categories = ['software engineering'];
export const tags = ['clean code', 'javascript', 'web development'];
