export const title = 'JavaScript Quirks, Vol. 1: The typeof operator';
export const date = '2022-06-25';
export const description = "Make sure you're aware of these typeof quirks!";
