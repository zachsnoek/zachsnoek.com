export const title = 'Use hooks in class components with a render prop';
export const date = '2021-02-28';
export const description = 'Learn how to use React hooks in a class component.';
