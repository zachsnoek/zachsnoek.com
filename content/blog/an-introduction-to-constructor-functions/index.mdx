export const title = 'An introduction to constructor functions';
export const date = '2021-04-19';
export const description = 'What are constructor functions in JavaScript?';
