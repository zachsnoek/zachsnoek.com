---
title: 'Creating Custom React Hooks: useConfirmTabClose'
date: '2021-03-29'
description: How to create a custom React hook to confirm tab close with the beforeunload event.
categories:
...
Cover photo by [Jessica Tan](https://unsplash.com/@whaleitsjessica?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](https://unsplash.com/s/photos/caution?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText).
