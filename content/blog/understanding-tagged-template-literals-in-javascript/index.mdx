export const title = 'Understanding tagged template literals in JavaScript';
export const date = '2022-03-26';
export const description = 'What are tagged template literals in JavaScript?';
