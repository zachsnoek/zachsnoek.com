export const title = 'How to build a chatroom app with React and Firebase';
export const date = '2022-07-05';
export const description = 'Build a realtime chat app with React and Firebase.';
